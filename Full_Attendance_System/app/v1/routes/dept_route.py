...
from app.v1.schemas.department_schemas import DepartmentCreate, DepartmentUpdate, DepartmentOut, DepartmentDetails
from app.v1.services.auth_services.dept_services import DepartmentAuthServices
